package  
{
	...
	{
		[Embed(source = "/../img/alleasy.png")]
		private const EASYSHEET:Class;
		
		[Embed(source = "/../img/allmedium.png")]
		private const MEDIUMSHEET:Class;
		
		[Embed(source = "/../img/allhard.png")]
		private const HARDSHEET:Class;
		
		[Embed(source = "/../img/allcredits.png")]
		private const CREDITSHEET:Class;
		
		[Embed(source = "/../img/allexit.png")]
		...
		public function GameWorld() 
		{
			...
			backdrop = new Backdrop(BACKGROUNDSHEET, false, false);
			//_easyButton.x = 400;
			//_easyButton.y = 200;
			yPos = 200
			xPos = 249
			...
			//backdrop = new Backdrop("/../img/menu_background.png");
